...
"""
LoginRequiredMixin 默认会返回 登陆的重定向
但是我们当前的视图 是通过ajax 来请求的, 我们应该返回json数据
LoginRequiredMixin不能返回我们当前返回JSON数据的需求
...
一.  把需求写下来
    ...
    前端做什么:
        前端需要告诉后端 ,在编辑(修改)哪一个, 更新的数据 也需要提交给后台
